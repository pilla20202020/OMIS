...
class BrandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.inventory.brand.index',compact('brands'));
    }
    ...
    {
        //
        return view('backend.inventory.brand.create');
    ...
    public function edit($id)
    {
        ...
        return view('backend.inventory.brand.edit',compact('brand'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($this->brand->delete($id)) {
            return redirect()->route('backend.inventory.brand.index');
        }
    }
