...
@section('content')
    <div class="content-wrapper">
        ...
        <form class="form form-validate floating-label" action="{{route('inventory.brand.update',$brand->id)}}"
                method="POST" enctype="multipart/form-data">
        @method('PUT')
        @include('backend.inventory.brand.partials.form', ['header' => 'Edit brand <span class="text-primary">('.($brand->name).')</span>'])
        </form>
    </div>
@stop
