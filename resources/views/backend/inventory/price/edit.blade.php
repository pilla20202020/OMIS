...
@section('content')
    <div class="content-wrapper">
        ...
        <form class="form form-validate floating-label" action="{{route('inventory.price.update',$price->id)}}"
                method="POST" enctype="multipart/form-data">
        @method('PUT')
        @include('backend.inventory.price.partials.form', ['header' => 'Edit price <span class="text-primary">('.($price->name).')</span>'])
        </form>
    </div>
@stop
