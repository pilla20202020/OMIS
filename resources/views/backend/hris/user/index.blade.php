...
@section('js')
    ...
    <script>
        let requestUrl = "{{ route('hris.user.list') }}";
        let editUrl = "{{ route('hris.user.edit') }}";
        let updateUrl = "{{ route('hris.user.update') }}";
        let storeUrl = "{{ route('hris.user.store') }}";
        let token = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('js/backend/hris/user_index.js') }}"></script>
